...
/* ═══════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════ */
function LoginPage({onSubmit,onBack,loading,prefillEmail,role}){
  ...
  return<div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center"}}><div className="fade-up" style={{background:"#10101a",border:"1px solid #1e1e2e",borderRadius:24,padding:"48px 40px",width:"100%",maxWidth:440,boxShadow:"0 24px 64px rgba(0,0,0,.5)"}}>
    <div style={{width:56,height:56,borderRadius:16,background:isAdmin?"linear-gradient(135deg,#ff2d00,#ff6b3d)":"linear-gradient(135deg,#3b82f6,#60a5fa)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 20px"}}>{isAdmin?<Shield size={26} color="#fff"/>:<User size={26} color="#fff"/>}</div>
    <h2 style={{fontFamily:"var(--font-display)",fontSize:24,fontWeight:700,textAlign:"center",marginBottom:4}}>{isAdmin?"Admin":"Mentor"} Login</h2>
...
/* ═══════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════ */
function CreateEmailPage({onSubmit,onBack,loading,role}){
  const[email,setEmail]=useState("")
  const isAdmin=role==="admin"
  return<div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center"}}><div className="fade-up" style={{background:"#10101a",border:"1px solid #1e1e2e",borderRadius:24,padding:"48px 40px",width:"100%",maxWidth:440,boxShadow:"0 24px 64px rgba(0,0,0,.5)"}}>
    <div style={{width:56,height:56,borderRadius:16,background:isAdmin?"linear-gradient(135deg,#ff2d00,#ff6b3d)":"linear-gradient(135deg,#3b82f6,#60a5fa)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 20px"}}><UserPlus size={26} color="#fff"/></div>
    <h2 style={{fontFamily:"var(--font-display)",fontSize:24,fontWeight:700,textAlign:"center",marginBottom:4}}>{isAdmin?"Admin":"Mentor"} Create Account</h2>
    <p style={{textAlign:"center",color:"#9898b0",fontSize:13,marginBottom:32}}>Enter your registered email to verify</p>
...
export default function App(){
  ...
  const[prefillEmail,setPrefillEmail]=useState("");const[loginRole,setLoginRole]=useState("mentor")
